$.getScript('/result/widgetfile/wgndexvestsummary/cytoscape.js', function () {});
    ...
    'info': {
        ...
        'function': function (parentDiv, data) {
            ...
            func.networkDiv.addEventListener('click', function (evt) {
                var options = document.getElementById('ndexvest_options_summary');
            ...
            // Network name area
            var div = getEl('div');
            div.id = 'ndexvest_select_summary';
            div.className = 'ndexvest_select_summary';
            ...
            optionsDiv.id = 'ndexvest_options_summary';
            ...
            for (var i = 0; i < enrichmentScoresFormatedForTable['body'].length; i++) {
                ...
                optionDiv.className = 'ndexvest_option_summary';
                ...
                optionDiv.onmouseenter = function (evt) {
                    document.getElementById('ndexvest_select_summary').textContent = 
                        'v ' + evt.target.getAttribute('networkname');
                    var options = document.getElementsByClassName('ndexvest_option_summary');
                    ...
                    document.getElementById('ndexvest_options_summary').focus();
                }
                optionDiv.onclick = function (evt) {
                    document.getElementById('ndexvest_options_summary').style.display 
                        = 'none';
                    var networkUUID = evt.target.getAttribute('networkid');
                    self.selectedNetworkName = evt.target.getAttribute('networkname');
                    var selectDiv = document.getElementById('ndexvest_select_summary');
            ...
            var option = optionsDiv.getElementsByClassName(
                    'ndexvest_option_summary')[0];
            var networkUUID = option.getAttribute('networkid');
            var networkName = option.getAttribute('networkname');
            optionsDiv.style.display = 'none';
            var select = func.enrichmentDiv.getElementsByClassName('ndexvest_select_summary')[0];
